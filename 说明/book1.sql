...
CREATE TABLE `annoucement` (
  ...
  `annouce_title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `annouce_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `annoucement` VALUES ('f2a3e61ecd9a11eb9e909c304ef0449f', '劳动节祝福', '五一来，祝福到，勤学习，快致富，身体棒，心情佳。', '2023-05-01 08:00:00');
...
CREATE TABLE `book` (
  `id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `book_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `author` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `publish_company` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES ('0286cb1acdb311ebbf9e9c304ef0449f', '自在独行', '贾平凹', '长江文艺出版社', '3', '2', '2023-05-20 16:23:49', '2016-06-01');
INSERT INTO `book` VALUES ('235c31a1cdb211eb968d9c304ef0449f', '老狐狸经', '山阴慧人', '延边人民出版社', '0', '1', '2023-05-20 16:23:49', '1998-11-01');
INSERT INTO `book` VALUES ('4965624dcdb211eba8099c304ef0449f', '尘埃落定', '阿来', '人民文学出版社', '4', '2', '2023-05-20 16:23:49', '1998-03-01');
INSERT INTO `book` VALUES ('9623fe85cdb111ebb9df9c304ef0449f', '海边的卡夫卡', '村上春树', '上海译文出版社', '4', '1', '2023-05-20 16:23:49', '2007-07-01');
INSERT INTO `book` VALUES ('9cdbf8e1cdb211ebb2259c304ef0449f', '万历十五年', '黄仁宇', '中华书局', '8', '0', '2023-05-20 16:23:49', '1982-05-01');
INSERT INTO `book` VALUES ('d19b6f68cdb211eb884f9c304ef0449f', '指弹吉他独奏曲集', '董宏峰', '安徽文艺出版社', '2', '0', '2023-05-20 16:23:49', '2018-07-01');
INSERT INTO `book` VALUES ('f93b3676cdb111eba9df9c304ef0449f', '计算机基础教程', '贾长隆', '大连理工大学出版社', '0', '1', '2023-05-20 16:23:49', '1994-06-01');
...
CREATE TABLE `borrow_info` (
  `id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `book_id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `book_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `borrow_user` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `borrow_info` VALUES ('090eb31ccdb811ebb6659c304ef0449f', '9623fe85cdb111ebb9df9c304ef0449f', '海边的卡夫卡', '张一', '1', '30', '2023-05-01 16:59:47', '2023-05-15 16:59:47', '0');
INSERT INTO `borrow_info` VALUES ('13118868cdde11ebbbbb9c304ef0449f', '235c31a1cdb211eb968d9c304ef0449f', '老狐狸经', '张二', '1', '5', '2023-05-03 21:32:05', '2023-05-18 21:32:05', '0');
INSERT INTO `borrow_info` VALUES ('182ba4d5cdde11eb89149c304ef0449f', 'f93b3676cdb111eba9df9c304ef0449f', '计算机基础教程', '张二', '1', '5', '2023-05-10 21:32:13', '2023-05-20 21:32:13', '1');
INSERT INTO `borrow_info` VALUES ('1f2560b6cdb811ebb6a49c304ef0449f', '4965624dcdb211eba8099c304ef0449f', '尘埃落定', '张一', '1', '20', '2023-05-11 17:00:24', '2023-05-21 17:00:24', '0');
INSERT INTO `borrow_info` VALUES ('7222993fcdde11eba0c69c304ef0449f', '0286cb1acdb311ebbf9e9c304ef0449f', '自在独行', '李四', '1', '10', '2023-05-11 21:34:44', '2023-05-23 21:34:44', '0');
INSERT INTO `borrow_info` VALUES ('a0bbcaf6cdde11ebb0c99c304ef0449f', '4965624dcdb211eba8099c304ef0449f', '尘埃落定', '李四', '1', '20', '2023-05-12 21:36:02', '2023-05-24 21:36:02', '0');
INSERT INTO `borrow_info` VALUES ('af5b3164fd0d11edbc816c6a774d9294', '0286cb1acdb311ebbf9e9c304ef0449f', '自在独行', '陈鹤轩', '1', '30', '2023-05-28 12:11:13', '2023-06-27 12:11:13', '0');
...
CREATE TABLE `douban_book` (
  `img_href` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `author` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `pub` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `pub_year` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `price` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `grade` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `remark_num` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `quote` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPACT;
...
CREATE TABLE `message` (
  `id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `sender_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `receiver_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `send_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `send_time` datetime DEFAULT NULL,
  `is_replied` int DEFAULT NULL,
  `reply_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES ('328485fccdde11eb99e59c304ef0449f', 'admin', '张一', '亲爱的张一同学，你借的书籍《张一》未还。请尽快还书，如逾期未还你的账号可能被冻结。', '2023-05-11 18:24:23', '2', null, null);
INSERT INTO `message` VALUES ('7e95ee12cdde11eba61c9c304ef0449f', '李四', 'admin', '我的借书卡掉了，去哪里补办呢？', '2023-05-19 11:17:28', '1', '科技楼左转最里面', '2023-05-28 00:33:16');
INSERT INTO `message` VALUES ('8b9e3ab7cdde11eb9d0f9c304ef0449f', '李四', 'admin', '能不能采购《枕草子》', '2023-05-20 23:24:23', '1', '能', '2023-05-28 00:32:20');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('12644064935811ea9063d8c497639e37', 'admin', '21232f297a57a5a743894a0e4a801fc3', '0', '2023-05-11 15:23:12', '0', '2023-05-11 15:24:23');
INSERT INTO `user` VALUES ('272e7d7bc73511eba19cd7bd2780f224', '张二', 'c81e728d9d4c2f636f067f89cc14862c', '1', '2023-05-12 10:07:46', '0', '2023-05-13 10:07:46');
INSERT INTO `user` VALUES ('2b0da9f7c73911eb85dbd7bd2780f224', '李四', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', '1', '2023-05-14 10:36:31', '0', '2023-05-14 00:36:31');
INSERT INTO `user` VALUES ('5310e4f1fcac11edb0046c6a774d9294', '陈鹤轩', 'e10adc3949ba59abbe56e057f20f883e', '1', '2023-05-28 00:34:17', '0', '2023-05-28 00:34:17');
INSERT INTO `user` VALUES ('99477a9e935811ea8171d8c497639e37', 'zhangsan', 'e10adc3949ba59abbe56e057f20f883e', '1', '2020-05-14 15:23:12', '0', '2023-05-15 15:24:23');
INSERT INTO `user` VALUES ('c10dcd40c73411ebb832d7bd2780f224', '张一', 'c4ca4238a0b923820dcc509a6f75849b', '1', '2023-05-15 10:04:55', '0', '2023-05-16 10:04:55');
